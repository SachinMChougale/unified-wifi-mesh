...
TEST_F(EmOrchTest, is_cmd_type_renew_in_progress_non_renew) {
    ...
    em_bus_event_type_t nonRenewTypes[] = {
        ...
        em_bus_event_type_onewifi_radio_cb, em_bus_event_type_onewifi_status_cb, em_bus_event_type_m2ctrl_configuration,
